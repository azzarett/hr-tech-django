...
class InvitationsRepository:
    ...
    @staticmethod
    def _base_queryset() -> QuerySet[Invitation]:
    ...
    @staticmethod
    def find_by_token(token) -> Optional[Invitation]:
        try:
    ...
    @staticmethod
    def find_by_id(id) -> Optional[Invitation]:
        try:
    ...
    @staticmethod
    def update_status(invitation: Invitation, status: str) -> Invitation:
        invitation.status = status
        invitation.save()
        return invitation

    @staticmethod
    def find_by_team_id(team_id) -> List[Invitation]:
        return list(
            InvitationsRepository._base_queryset()
